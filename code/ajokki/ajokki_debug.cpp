...
namespace ajokki
{
    void set_debug_variables(ylikuutio::config::SettingMaster* setting_master)
    {
        ...
        is_flight_mode_in_use_setting_struct.activate_callback = &ylikuutio::config::SettingMaster::activate_is_flight_mode_in_use;
        is_flight_mode_in_use_setting_struct.read_callback = &ylikuutio::config::SettingMaster::read_is_flight_mode_in_use;
        is_flight_mode_in_use_setting_struct.should_ylikuutio_call_activate_callback_now = true;
        new ylikuutio::config::Setting(is_flight_mode_in_use_setting_struct);
    }
}
