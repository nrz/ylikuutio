...
[![Codacy Badge](https://app.codacy.com/project/badge/Grade/0d0d48dc3b6947b2ac90bebd1f3a07f2)](https://app.codacy.com/gh/nrz/ylikuutio/dashboard?utm_source=gh&utm_medium=referral&utm_content=&utm_campaign=Badge_grade)
...
cmake g++ gcc libx11-dev libgl1-mesa-dev libglu1-mesa-dev libpng-dev libvulkan-dev libxcursor-dev libxrandr-dev libxext-dev libxi-dev libxinerama-dev ninja-build vulkan-utility-libraries-dev zlib1g-dev

Eg. with apt:

    $ sudo apt install cmake build-essential libx11-dev libgl1-mesa-dev libglu1-mesa-dev libpng-dev libvulkan-dev libxcursor-dev libxrandr-dev libxext-dev libxi-dev libxinerama-dev ninja-build vulkan-utility-libraries-dev zlib1g-dev
...
A: In [Debian GNU/Linux](https://www.debian.org/)
   ([Debian Trixie](https://wiki.debian.org/DebianTrixie) at the moment),
   using [CLion](https://www.jetbrains.com/clion/) and [Vim](https://www.vim.org/).
   Other tools in use include [Valgrind](http://valgrind.org/),
...
* [fastgltf](https://github.com/spnda/fastgltf) is licensed under [the MIT license](https://github.com/spnda/fastgltf/blob/main/LICENSE.md).
...
* [Realistic Animated Bear 3D Model](https://skfb.ly/pwvXN) by WildMesh 3D is licensed under [Creative Commons Attribution](http://creativecommons.org/licenses/by/4.0/).
* [Realistic Animated Elk 3D Model](https://skfb.ly/pFGDA) by WildMesh 3D is licensed under [Creative Commons Attribution](http://creativecommons.org/licenses/by/4.0/).
