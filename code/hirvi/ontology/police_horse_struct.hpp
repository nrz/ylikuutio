...
#ifndef YLI_ONTOLOGY_POLICE_HORSE_STRUCT_HPP_INCLUDED
#define YLI_ONTOLOGY_POLICE_HORSE_STRUCT_HPP_INCLUDED
...
{
    struct PoliceHorseStruct final : yli::ontology::HolobiontStruct
    {
        PoliceHorseStruct(
