...
#ifndef YLI_ONTOLOGY_POLICE_TRAM_STRUCT_HPP_INCLUDED
#define YLI_ONTOLOGY_POLICE_TRAM_STRUCT_HPP_INCLUDED
...
{
    struct PoliceTramStruct final : yli::ontology::HolobiontStruct
    {
        PoliceTramStruct(
