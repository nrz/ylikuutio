...
namespace hirvi
{
    ...
    void HirviApplication::create_memory_allocators()
    {
        ...
        this->memory_system.create_allocator<Font2DMemoryAllocator>(hirvi::Datatype::FONT_2D);
        this->memory_system.create_allocator<Text2DMemoryAllocator>(hirvi::Datatype::TEXT_2D);
        ...
        this->memory_system.create_allocator<ConsoleCallbackEngineMemoryAllocator>(hirvi::Datatype::CONSOLE_CALLBACK_ENGINE);
        this->memory_system.create_allocator<ConsoleCallbackObjectMemoryAllocator>(hirvi::Datatype::CONSOLE_CALLBACK_OBJECT);
