...
- [x] LIBRARIES/AUDIO Replace SoLoud with SDL3 audio. https://examples.libsdl.org/SDL3/audio/
- [x] LIBRARIES/AUDIO Use SDL_mixer 3.0 for mixing audio. https://github.com/libsdl-org/SDL_mixer
