...
namespace ajokki
{
    void set_location_and_orientation(ylikuutio::config::SettingMaster* const setting_master)
    {
        ...
        spherical_coordinates_setting_struct.activate_callback = &ylikuutio::config::SettingMaster::activate_spherical_coordinates;
        spherical_coordinates_setting_struct.should_ylikuutio_call_activate_callback_now = true;
        std::cout << "Executing `new ylikuutio::config::Setting(spherical_coordinates_setting_struct);` ...\n";
        new ylikuutio::config::Setting(spherical_coordinates_setting_struct);
        ...
        rho_setting_struct.activate_callback = &ylikuutio::config::SettingMaster::activate_rho;
        rho_setting_struct.read_callback = &ylikuutio::config::SettingMaster::read_rho;
        rho_setting_struct.should_ylikuutio_call_activate_callback_now = true;
        std::cout << "Executing `new ylikuutio::config::Setting(rho_setting_struct);` ...\n";
        new ylikuutio::config::Setting(rho_setting_struct);
        ...
        theta_setting_struct.activate_callback = &ylikuutio::config::SettingMaster::activate_theta;
        theta_setting_struct.read_callback = &ylikuutio::config::SettingMaster::read_theta;
        theta_setting_struct.should_ylikuutio_call_activate_callback_now = true;
        std::cout << "Executing `new ylikuutio::config::Setting(theta_setting_struct);` ...\n";
        new ylikuutio::config::Setting(theta_setting_struct);
        ...
        phi_setting_struct.activate_callback = &ylikuutio::config::SettingMaster::activate_phi;
        phi_setting_struct.read_callback = &ylikuutio::config::SettingMaster::read_phi;
        phi_setting_struct.should_ylikuutio_call_activate_callback_now = true;
        std::cout << "Executing `new ylikuutio::config::Setting(phi_setting_struct);` ...\n";
        new ylikuutio::config::Setting(phi_setting_struct);
        ...
        horizontal_angle_setting_struct.activate_callback = &ylikuutio::config::SettingMaster::activate_horizontal_angle;
        horizontal_angle_setting_struct.read_callback = &ylikuutio::config::SettingMaster::read_horizontal_angle;
        horizontal_angle_setting_struct.should_ylikuutio_call_activate_callback_now = true;
        std::cout << "Executing `new ylikuutio::config::Setting(horizontal_angle_setting_struct);` ...\n";
        new ylikuutio::config::Setting(horizontal_angle_setting_struct);
        ...
        vertical_angle_setting_struct.activate_callback = &ylikuutio::config::SettingMaster::activate_vertical_angle;
        vertical_angle_setting_struct.read_callback = &ylikuutio::config::SettingMaster::read_vertical_angle;
        vertical_angle_setting_struct.should_ylikuutio_call_activate_callback_now = true;
        std::cout << "Executing `new ylikuutio::config::Setting(vertical_angle_setting_struct);` ...\n";
        new ylikuutio::config::Setting(vertical_angle_setting_struct);
        ...
        right_setting_struct.read_callback = &ylikuutio::config::SettingMaster::read_right;
        right_setting_struct.should_ylikuutio_call_activate_callback_now = false;
        std::cout << "Executing `new ylikuutio::config::Setting(right_setting_struct);` ...\n";
        new ylikuutio::config::Setting(right_setting_struct);
        ...
        up_setting_struct.read_callback = &ylikuutio::config::SettingMaster::read_up;
        up_setting_struct.should_ylikuutio_call_activate_callback_now = false;
        std::cout << "Executing `new ylikuutio::config::Setting(up_setting_struct);` ...\n";
        new ylikuutio::config::Setting(up_setting_struct);
