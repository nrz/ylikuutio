...
#ifndef YLI_ONTOLOGY_POLICE_HELICOPTER_STRUCT_HPP_INCLUDED
#define YLI_ONTOLOGY_POLICE_HELICOPTER_STRUCT_HPP_INCLUDED
...
{
    struct PoliceHelicopterStruct final : yli::ontology::HolobiontStruct
    {
