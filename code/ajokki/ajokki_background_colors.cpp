...
namespace ajokki
{
    void set_background_colors(config::SettingMaster* setting_master)
    {
        ...
        SettingStruct red_setting_struct(new datatypes::AnyValue(float_zero));
        ...
        SettingStruct green_setting_struct(new datatypes::AnyValue(float_zero));
        ...
        SettingStruct blue_setting_struct(new datatypes::AnyValue(float_one));
        ...
        SettingStruct alpha_setting_struct(new datatypes::AnyValue(float_zero));
