...
#ifndef YLIKUUTIO_SNIPPETS_LOCOMOTION_ROAD_VEHICLE_MODULE_HPP_INCLUDED
#define YLIKUUTIO_SNIPPETS_LOCOMOTION_ROAD_VEHICLE_MODULE_HPP_INCLUDED
...
{
    class RoadVehicleModule final : public ontology::LocomotionModule
    {
        public:
            explicit RoadVehicleModule(const ontology::LocomotionModuleStruct& road_vehicle_module_struct);
