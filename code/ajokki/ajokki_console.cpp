...
namespace ajokki
{
    void set_console(ylikuutio::config::SettingMaster* const setting_master)
    {
        ...
        new ylikuutio::config::Setting(console_top_y_setting_struct);
        ...
        new ylikuutio::config::Setting(console_bottom_y_setting_struct);
        ...
        new ylikuutio::config::Setting(console_right_x_setting_struct);
        ...
        new ylikuutio::config::Setting(console_left_x_setting_struct);
    }
}
