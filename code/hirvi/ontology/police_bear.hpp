...
#ifndef HIRVI_ONTOLOGY_POLICE_BEAR_HPP_INCLUDED
#define HIRVI_ONTOLOGY_POLICE_BEAR_HPP_INCLUDED
...
{
    struct PoliceBearStruct;

    class PoliceBear : public yli::ontology::Holobiont
    {
    public:
        explicit PoliceBear(
            yli::core::Application& application,
            yli::ontology::Universe& universe,
            const PoliceBearStruct& police_bear_struct,
        ...
        PoliceBear(const PoliceBear&) = delete; // Delete copy constructor.

        PoliceBear& operator=(const PoliceBear&) = delete; // Delete copy assignment.

        ~PoliceBear() override = default;
