...
namespace yli::snippets
{
    void set_background_colors(yli::ontology::Universe* universe, const float red, const float green, const float blue, const float alpha)
    {
        ...
        yli::ontology::VariableStruct red_variable_struct(*universe);
        ...
        yli::ontology::VariableStruct green_variable_struct(*universe);
        ...
        yli::ontology::VariableStruct blue_variable_struct(*universe);
        ...
        yli::ontology::VariableStruct alpha_variable_struct(*universe);
