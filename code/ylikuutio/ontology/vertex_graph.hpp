...
#ifndef __YLIKUUTIO_ONTOLOGY_VERTEX_GRAPH_HPP_INCLUDED
#define __YLIKUUTIO_ONTOLOGY_VERTEX_GRAPH_HPP_INCLUDED
...
{
    class VertexGraph final : public yli::graph::Graph
    {
        public:
