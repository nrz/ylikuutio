...
TEST(line2D_must_be_defined_as_expected, line2D_std_vector_float_x1_0_y1_0_x2_1_y2_1)
{
    ...
    const ylikuutio::geometry::Line2D line1 = ylikuutio::geometry::Line2D(point1, point2);
    ...
    const ylikuutio::geometry::Line2D line2 = ylikuutio::geometry::Line2D(std::vector<float>{ 0.0f, 0.0f }, std::vector<float>{ 1.0f, 1.0f });
...
{
    const ylikuutio::geometry::Line2D line_std_vector_float = ylikuutio::geometry::Line2D(std::vector<float>{ 0.0f, 0.0f }, std::vector<float>{ 0.0f, 1.0f });
    const ylikuutio::geometry::Line2D line_glm_vec2 = ylikuutio::geometry::Line2D(glm::vec2(0.0f, 0.0f), glm::vec2(0.0f, 1.0f));
...
{
    const ylikuutio::geometry::Line2D line_std_vector_float = ylikuutio::geometry::Line2D(std::vector<float>{ 0.0f, 0.0f }, std::vector<float>{ 1.0f, 0.0f });
    const ylikuutio::geometry::Line2D line_glm_vec2 = ylikuutio::geometry::Line2D(glm::vec2(0.0f, 0.0f), glm::vec2(1.0f, 0.0f));
    ASSERT_TRUE(line_std_vector_float.is_identical_with(&line_glm_vec2));
    ASSERT_TRUE(line_glm_vec2.is_identical_with(&line_std_vector_float));
}
...
{
    const ylikuutio::geometry::Line2D line_std_vector_float = ylikuutio::geometry::Line2D(std::vector<float>{ 0.0f, 0.0f }, std::vector<float>{ 1.0f, 1.0f });
    const ylikuutio::geometry::Line2D line_glm_vec2 = ylikuutio::geometry::Line2D(glm::vec2(0.0f, 0.0f), glm::vec2(1.0f, 1.0f));
    ASSERT_TRUE(line_std_vector_float.is_identical_with(&line_glm_vec2));
    ASSERT_TRUE(line_glm_vec2.is_identical_with(&line_std_vector_float));
}
...
{
    const ylikuutio::geometry::Line2D line1_std_vector_float = ylikuutio::geometry::Line2D(std::vector<float>{ 0.0f, 0.0f }, std::vector<float>{ 0.0f, 1.0f });
    const ylikuutio::geometry::Line2D line2_std_vector_float = ylikuutio::geometry::Line2D(std::vector<float>{ 0.0f, 1.0f }, std::vector<float>{ 0.0f, 0.0f });
...
{
    const ylikuutio::geometry::Line2D line1_std_vector_float = ylikuutio::geometry::Line2D(std::vector<float>{ 1.0f, 2.0f }, std::vector<float>{ 3.0f, 4.0f });
    const ylikuutio::geometry::Line2D line2_std_vector_float = ylikuutio::geometry::Line2D(std::vector<float>{ 3.0f, 4.0f }, std::vector<float>{ 1.0f, 2.0f });
    ASSERT_FALSE(line1_std_vector_float.is_identical_with(&line2_std_vector_float));
    ASSERT_FALSE(line2_std_vector_float.is_identical_with(&line1_std_vector_float));
}
...
{
    const ylikuutio::geometry::Line2D line1_std_vector_float = ylikuutio::geometry::Line2D(std::vector<float>{ 1.0f, 2.0f }, std::vector<float>{ 3.0f, 4.0f });
    const ylikuutio::geometry::Line2D line2_std_vector_float = ylikuutio::geometry::Line2D(std::vector<float>{ 2.0f, 1.0f }, std::vector<float>{ 4.0f, 3.0f });
    ASSERT_FALSE(line1_std_vector_float.is_identical_with(&line2_std_vector_float));
    ASSERT_FALSE(line2_std_vector_float.is_identical_with(&line1_std_vector_float));
}
...
TEST(line2D_must_be_defined_as_expected, line2D_x1_340_y1_150_x2_100_y2_50)
{
    ...
    const ylikuutio::geometry::Line2D* const line1 = new ylikuutio::geometry::Line2D(point1, point2);
    const ylikuutio::geometry::Line2D* const line2 = new ylikuutio::geometry::Line2D(std::vector<float>{ x1, y1 }, std::vector<float>{ x2, y2 });
