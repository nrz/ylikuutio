...
namespace ajokki
{
    ylikuutio::ontology::Entity* create_helsinki_east_downtown_scene(ylikuutio::ontology::EntityFactory* entity_factory, ylikuutio::ontology::World* const world)
    {
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* helsinki_east_downtown_scene_entity ...\n";
        ylikuutio::ontology::Entity* helsinki_east_downtown_scene_entity = entity_factory->create_Scene(world, 0.9f);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* helsinki_east_downtown_shader_entity ...\n";
        ylikuutio::ontology::Entity* helsinki_east_downtown_shader_entity = entity_factory->create_Shader(helsinki_east_downtown_shader_struct);
        std::cout << "Creating ylikuutio::ontology::Shader* helsinki_east_downtown_shader ...\n";
        ylikuutio::ontology::Shader* helsinki_east_downtown_shader = dynamic_cast<ylikuutio::ontology::Shader*>(helsinki_east_downtown_shader_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* helsinki_east_downtown_grass_material_entity ...\n";
        ylikuutio::ontology::Entity* helsinki_east_downtown_grass_material_entity = entity_factory->create_Material(helsinki_east_downtown_grass_material_struct);
        std::cout << "Creating ylikuutio::ontology::Material* helsinki_east_downtown_grass_material ...\n";
        ylikuutio::ontology::Material* helsinki_east_downtown_grass_material = dynamic_cast<ylikuutio::ontology::Material*>(helsinki_east_downtown_grass_material_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* pink_geometric_tiles_material_entity ...\n";
        ylikuutio::ontology::Entity* pink_geometric_tiles_material_entity = entity_factory->create_Material(pink_geometric_tiles_material_struct);
        std::cout << "Creating ylikuutio::ontology::Material* pink_geometric_tiles_material ...\n";
        ylikuutio::ontology::Material* pink_geometric_tiles_material = dynamic_cast<ylikuutio::ontology::Material*>(pink_geometric_tiles_material_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* orange_fur_material_entity ...\n";
        ylikuutio::ontology::Entity* orange_fur_material_entity = entity_factory->create_Material(orange_fur_material_struct);
        std::cout << "Creating ylikuutio::ontology::Material* orange_fur_material ...\n";
        ylikuutio::ontology::Material* orange_fur_material = dynamic_cast<ylikuutio::ontology::Material*>(orange_fur_material_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* helsinki_east_downtown_terrain_species_entity ...\n";
        ylikuutio::ontology::Entity* helsinki_east_downtown_terrain_species_entity = entity_factory->create_Species(helsinki_east_downtown_terrain_species_struct);
        std::cout << "Creating ylikuutio::ontology::Species* helsinki_east_downtown_terrain_species ...\n";
        ylikuutio::ontology::Species* helsinki_east_downtown_terrain_species = dynamic_cast<ylikuutio::ontology::Species*>(helsinki_east_downtown_terrain_species_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* suzanne_species_entity ...\n";
        ylikuutio::ontology::Entity* suzanne_species_entity = entity_factory->create_Species(suzanne_species_struct);
        std::cout << "Creating ylikuutio::ontology::Species* suzanne_species ...\n";
        ylikuutio::ontology::Species* suzanne_species = dynamic_cast<ylikuutio::ontology::Species*>(suzanne_species_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* suzanne1_entity ...\n";
        ylikuutio::ontology::Entity* suzanne1_entity = entity_factory->create_Object(suzanne_object_struct1);
        std::cout << "Creating ylikuutio::ontology::Species* suzanne1 ...\n";
        ylikuutio::ontology::Object* suzanne1 = dynamic_cast<ylikuutio::ontology::Object*>(suzanne1_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* suzanne2_entity ...\n";
        ylikuutio::ontology::Entity* suzanne2_entity = entity_factory->create_Object(suzanne_object_struct2);
        std::cout << "Creating ylikuutio::ontology::Species* suzanne2 ...\n";
        ylikuutio::ontology::Object* suzanne2 = dynamic_cast<ylikuutio::ontology::Object*>(suzanne2_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* suzanne3_entity ...\n";
        ylikuutio::ontology::Entity* suzanne3_entity = entity_factory->create_Object(suzanne_object_struct3);
        std::cout << "Creating ylikuutio::ontology::Species* suzanne3 ...\n";
        ylikuutio::ontology::Object* suzanne3 = dynamic_cast<ylikuutio::ontology::Object*>(suzanne3_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* suzanne4_entity ...\n";
        ylikuutio::ontology::Entity* suzanne4_entity = entity_factory->create_Object(suzanne_object_struct4);
        std::cout << "Creating ylikuutio::ontology::Species* suzanne4 ...\n";
        ylikuutio::ontology::Object* suzanne4 = dynamic_cast<ylikuutio::ontology::Object*>(suzanne4_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* suzanne5_entity ...\n";
        ylikuutio::ontology::Entity* suzanne5_entity = entity_factory->create_Object(suzanne_object_struct5);
        std::cout << "Creating ylikuutio::ontology::Species* suzanne5 ...\n";
        ylikuutio::ontology::Object* suzanne5 = dynamic_cast<ylikuutio::ontology::Object*>(suzanne5_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* cat_species_entity ...\n";
        ylikuutio::ontology::Entity* cat_species_entity = entity_factory->create_Species(cat_species_struct);

        std::cout << "Creating ylikuutio::ontology::Species* cat_species ...\n";
        ylikuutio::ontology::Species* cat_species = dynamic_cast<ylikuutio::ontology::Species*>(cat_species_entity);
        ...
        ylikuutio::ontology::Entity* cat1_entity = entity_factory->create_Object(cat_object_struct1);
        ylikuutio::ontology::Object* cat1 = dynamic_cast<ylikuutio::ontology::Object*>(cat1_entity);
        ...
        ylikuutio::ontology::Entity* cat2_entity = entity_factory->create_Object(cat_object_struct2);
        ylikuutio::ontology::Object* cat2 = dynamic_cast<ylikuutio::ontology::Object*>(cat2_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* freight_train_symbiosis_entity ...\n";
        ylikuutio::ontology::Entity* freight_train_symbiosis_entity = entity_factory->create_Symbiosis(freight_train_symbiosis_struct);

        std::cout << "Creating ylikuutio::ontology::Symbiosis* freight_train_symbiosis ...\n";
        ylikuutio::ontology::Symbiosis* freight_train_symbiosis = dynamic_cast<ylikuutio::ontology::Symbiosis*>(freight_train_symbiosis_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* freight_train1_entity ...\n";

        ylikuutio::ontology::Entity* freight_train1_entity = entity_factory->create_Holobiont(freight_train_object_struct1);

        std::cout << "Creating ylikuutio::ontology::Holobiont* freight_train1 ...\n";

        ylikuutio::ontology::Holobiont* freight_train1 = dynamic_cast<ylikuutio::ontology::Holobiont*>(freight_train1_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* turbo_polizei_symbiosis_entity ...\n";
        ylikuutio::ontology::Entity* turbo_polizei_symbiosis_entity = entity_factory->create_Symbiosis(turbo_polizei_symbiosis_struct);

        std::cout << "Creating ylikuutio::ontology::Symbiosis* turbo_polizei_symbiosis ...\n";
        ylikuutio::ontology::Symbiosis* turbo_polizei_symbiosis = dynamic_cast<ylikuutio::ontology::Symbiosis*>(turbo_polizei_symbiosis_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* turbo_polizei1_entity ...\n";

        ylikuutio::ontology::Entity* turbo_polizei1_entity = entity_factory->create_Holobiont(turbo_polizei_object_struct1);

        std::cout << "Creating ylikuutio::ontology::Holobiont* turbo_polizei1 ...\n";

        ylikuutio::ontology::Holobiont* turbo_polizei1 = dynamic_cast<ylikuutio::ontology::Holobiont*>(turbo_polizei1_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* fantasy_house_with_balcony_symbiosis_entity ...\n";
        ylikuutio::ontology::Entity* fantasy_house_with_balcony_symbiosis_entity = entity_factory->create_Symbiosis(fantasy_house_with_balcony_symbiosis_struct);

        std::cout << "Creating ylikuutio::ontology::Symbiosis* fantasy_house_with_balcony_symbiosis ...\n";
        ylikuutio::ontology::Symbiosis* fantasy_house_with_balcony_symbiosis = dynamic_cast<ylikuutio::ontology::Symbiosis*>(fantasy_house_with_balcony_symbiosis_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* fantasy_house_with_balcony1_entity ...\n";

        ylikuutio::ontology::Entity* fantasy_house_with_balcony1_entity = entity_factory->create_Holobiont(fantasy_house_with_balcony_object_struct1);

        std::cout << "Creating ylikuutio::ontology::Holobiont* fantasy_house_with_balcony1 ...\n";

        ylikuutio::ontology::Holobiont* fantasy_house_with_balcony1 = dynamic_cast<ylikuutio::ontology::Holobiont*>(fantasy_house_with_balcony1_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* fantasy_house_with_balcony2_entity ...\n";

        ylikuutio::ontology::Entity* fantasy_house_with_balcony2_entity = entity_factory->create_Holobiont(fantasy_house_with_balcony_object_struct2);

        std::cout << "Creating ylikuutio::ontology::Holobiont* fantasy_house_with_balcony2 ...\n";

        ylikuutio::ontology::Holobiont* fantasy_house_with_balcony2 = dynamic_cast<ylikuutio::ontology::Holobiont*>(fantasy_house_with_balcony2_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* kongtext_font_entity ...\n";
        ylikuutio::ontology::Entity* kongtext_font_entity = entity_factory->create_VectorFont(kongtext_vector_font_struct);
        std::cout << "Creating ylikuutio::ontology::VectorFont* kongtext_font ...\n";
        ylikuutio::ontology::VectorFont* kongtext_font = dynamic_cast<ylikuutio::ontology::VectorFont*>(kongtext_font_entity);
