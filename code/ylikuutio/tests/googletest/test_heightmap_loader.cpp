...
TEST(vertices_must_be_defined_and_interpolated_appropriately, a_3x3_terrain)
{
    ...
    *input_vertex_pointer++ = 128.0f;
    ...
    ylikuutio::geometry::define_vertices(
            input_vertex_data,
            image_width,
            image_height,
            x_step,
    ...
    ASSERT_TRUE(ylikuutio::geometry::interpolate_and_define_vertices_using_bilinear_interpolation(
                input_vertex_data,
                image_width,
                image_height,
                x_step,
    ...
    ASSERT_TRUE(ylikuutio::geometry::compute_face_normals(
                temp_vertices,
...
TEST(face_indices_must_be_computed_appropriately, a_4x4_terrain)
{
    ...
    // x = 0, z = 0.
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(0, 0, ylikuutio::geometry::ENE, example_width), 0);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(0, 0, ylikuutio::geometry::NNE, example_width), 1);

    // x = 1, z = 0.
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 0, ylikuutio::geometry::WNW, example_width), 0);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 0, ylikuutio::geometry::NNW, example_width), 3);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 0, ylikuutio::geometry::NNE, example_width), 5);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 0, ylikuutio::geometry::ENE, example_width), 4);

    // x = 2, z = 0.
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 0, ylikuutio::geometry::WNW, example_width), 4);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 0, ylikuutio::geometry::NNW, example_width), 7);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 0, ylikuutio::geometry::NNE, example_width), 9);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 0, ylikuutio::geometry::ENE, example_width), 8);

    // x = 3, z = 0.
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(3, 0, ylikuutio::geometry::WNW, example_width), 8);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(3, 0, ylikuutio::geometry::NNW, example_width), 11);

    // x = 0, z = 1.
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(0, 1, ylikuutio::geometry::NNE, example_width), 13);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(0, 1, ylikuutio::geometry::ENE, example_width), 12);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(0, 1, ylikuutio::geometry::ESE, example_width), 2);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(0, 1, ylikuutio::geometry::SSE, example_width), 1);

    // x = 1, z = 1.
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 1, ylikuutio::geometry::NNE, example_width), 17);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 1, ylikuutio::geometry::ENE, example_width), 16);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 1, ylikuutio::geometry::ESE, example_width), 6);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 1, ylikuutio::geometry::SSE, example_width), 5);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 1, ylikuutio::geometry::SSW, example_width), 3);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 1, ylikuutio::geometry::WSW, example_width), 2);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 1, ylikuutio::geometry::WNW, example_width), 12);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 1, ylikuutio::geometry::NNW, example_width), 15);

    // x = 2, z = 1.
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 1, ylikuutio::geometry::NNE, example_width), 21);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 1, ylikuutio::geometry::ENE, example_width), 20);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 1, ylikuutio::geometry::ESE, example_width), 10);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 1, ylikuutio::geometry::SSE, example_width), 9);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 1, ylikuutio::geometry::SSW, example_width), 7);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 1, ylikuutio::geometry::WSW, example_width), 6);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 1, ylikuutio::geometry::WNW, example_width), 16);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 1, ylikuutio::geometry::NNW, example_width), 19);

    // x = 3, z = 1.
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(3, 1, ylikuutio::geometry::SSW, example_width), 11);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(3, 1, ylikuutio::geometry::WSW, example_width), 10);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(3, 1, ylikuutio::geometry::WNW, example_width), 20);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(3, 1, ylikuutio::geometry::NNW, example_width), 23);

    // x = 0, z = 2.
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(0, 2, ylikuutio::geometry::NNE, example_width), 25);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(0, 2, ylikuutio::geometry::ENE, example_width), 24);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(0, 2, ylikuutio::geometry::ESE, example_width), 14);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(0, 2, ylikuutio::geometry::SSE, example_width), 13);

    // x = 1, z = 2.
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 2, ylikuutio::geometry::NNE, example_width), 29);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 2, ylikuutio::geometry::ENE, example_width), 28);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 2, ylikuutio::geometry::ESE, example_width), 18);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 2, ylikuutio::geometry::SSE, example_width), 17);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 2, ylikuutio::geometry::SSW, example_width), 15);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 2, ylikuutio::geometry::WSW, example_width), 14);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 2, ylikuutio::geometry::WNW, example_width), 24);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(1, 2, ylikuutio::geometry::NNW, example_width), 27);

    // x = 2, z = 2.
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 2, ylikuutio::geometry::NNE, example_width), 33);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 2, ylikuutio::geometry::ENE, example_width), 32);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 2, ylikuutio::geometry::ESE, example_width), 22);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 2, ylikuutio::geometry::SSE, example_width), 21);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 2, ylikuutio::geometry::SSW, example_width), 19);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 2, ylikuutio::geometry::WSW, example_width), 18);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 2, ylikuutio::geometry::WNW, example_width), 28);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(2, 2, ylikuutio::geometry::NNW, example_width), 31);

    // x = 3, z = 2.
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(3, 2, ylikuutio::geometry::SSW, example_width), 23);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(3, 2, ylikuutio::geometry::WSW, example_width), 22);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(3, 2, ylikuutio::geometry::WNW, example_width), 32);
    ASSERT_EQ(ylikuutio::geometry::get_face_normal_i(3, 2, ylikuutio::geometry::NNW, example_width), 35);
}
...
TEST(a_2x2_terrain_must_be_triangulated_appropriately, bilinear_interpolation)
{
    ...
    *vertex_pointer++ = northeast_height;
    ...
    ylikuutio::geometry::TriangulateQuadsStruct triangulate_quads_struct;
    triangulate_quads_struct.image_width = image_width;
    triangulate_quads_struct.image_height = image_height;
    triangulate_quads_struct.sphere_radius = NAN;
    triangulate_quads_struct.spherical_terrain_struct = ylikuutio::geometry::SphericalTerrainStruct(); // not used, but is needed in the function call.

    triangulate_quads_struct.triangulation_type = "bilinear_interpolation";

    const bool is_success = ylikuutio::geometry::triangulate_quads(vertex_data, triangulate_quads_struct, vertices, UVs, normals);
