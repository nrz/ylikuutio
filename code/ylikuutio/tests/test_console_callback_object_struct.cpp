...
TEST(console_callback_object_struct_must_be_initialized_appropriately, parent_provided_as_nullptr)
{
    ...
    ASSERT_FALSE(std::holds_alternative<std::string>(test_console_callback_object_struct.console_callback_engine_parent.data));
    ASSERT_EQ(std::get<yli::ontology::ConsoleCallbackEngine*>(test_console_callback_object_struct.console_callback_engine_parent.data), nullptr);
}
...
TEST(console_callback_object_struct_must_be_initialized_appropriately, parent_provided_as_global_name)
{
    ...
    ASSERT_TRUE(std::holds_alternative<std::string>(test_console_callback_object_struct.console_callback_engine_parent.data));
    ASSERT_EQ(std::get<std::string>(test_console_callback_object_struct.console_callback_engine_parent.data), "foo");
}
