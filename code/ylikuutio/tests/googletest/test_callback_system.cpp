...
std::shared_ptr<datatypes::AnyValue> square(ylikuutio::callback_system::CallbackEngine*, ylikuutio::callback_system::CallbackObject*, std::vector<ylikuutio::callback_system::CallbackParameter*>& input_parameters)
{
...
std::shared_ptr<datatypes::AnyValue> square_last(ylikuutio::callback_system::CallbackEngine* callback_engine,
        ylikuutio::callback_system::CallbackObject*,
        std::vector<ylikuutio::callback_system::CallbackParameter*>& input_parameters)
{
...
std::shared_ptr<datatypes::AnyValue> expt(ylikuutio::callback_system::CallbackEngine*, ylikuutio::callback_system::CallbackObject*, std::vector<ylikuutio::callback_system::CallbackParameter*>& input_parameters)
{
...
std::shared_ptr<datatypes::AnyValue> neg(ylikuutio::callback_system::CallbackEngine*, ylikuutio::callback_system::CallbackObject*, std::vector<ylikuutio::callback_system::CallbackParameter*>& input_parameters)
{
    if (input_parameters.size() != 1)
    {
        std::cout << "The size of input_parameter is " << input_parameters.size() << "\n";
...
{
    ylikuutio::callback_system::CallbackEngine* callback_engine = new ylikuutio::callback_system::CallbackEngine();
    ylikuutio::callback_system::CallbackObject* callback_object = new ylikuutio::callback_system::CallbackObject(nullptr, callback_engine);
    ...
    new ylikuutio::callback_system::CallbackParameter("", zero_value, is_reference_0, callback_object);
...
TEST(callback_engine_must_function_properly, int32_t_one_negated_equals_minus_one)
{
    ...
    new ylikuutio::callback_system::CallbackParameter("", one_value, is_reference_1, callback_object);
...
TEST(callback_engine_must_function_properly, int32_t_two_negated_equals_minus_two)
{
    ...
    new ylikuutio::callback_system::CallbackParameter("", two_value, is_reference_2, callback_object);
...
TEST(callback_engine_must_function_properly, int32_t_minus_one_negated_equals_one)
{
    ...
    new ylikuutio::callback_system::CallbackParameter("", minus_one_value, is_reference_minus_1, callback_object);
...
TEST(callback_engine_must_function_properly, int32_t_minus_two_negated_equals_two)
{
    ...
    new ylikuutio::callback_system::CallbackParameter("", minus_two_value, is_reference_minus_2, callback_object);
...
TEST(callback_engine_must_function_properly, int32_t_three_squared_equals_nine)
{
    ...
    new ylikuutio::callback_system::CallbackParameter("foo", three_value, is_reference_3, callback_object);
...
TEST(callback_engine_must_function_properly, uint32_t_5_expt_7_equals_78125)
{
    ...
    new ylikuutio::callback_system::CallbackParameter("foo", five_value, is_reference_5, callback_object);
    ...
    new ylikuutio::callback_system::CallbackParameter("foo", seven_value, is_reference_7, callback_object);
...
TEST(callback_engine_must_function_properly, uint32_t_5_expt_7_equals_78125_with_named_inputs)
{
    ...
    const bool is_reference_5 = false;
    std::shared_ptr<datatypes::AnyValue> five_value = std::make_shared<datatypes::AnyValue>(five);
    new ylikuutio::callback_system::CallbackParameter("base", five_value, is_reference_5, callback_object);
    ...
    const bool is_reference_7 = false;
    std::shared_ptr<datatypes::AnyValue> seven_value = std::make_shared<datatypes::AnyValue>(seven);
    new ylikuutio::callback_system::CallbackParameter("exponent", seven_value, is_reference_7, callback_object);
...
{
    ylikuutio::callback_system::CallbackEngine* callback_engine = new ylikuutio::callback_system::CallbackEngine();
    ylikuutio::callback_system::CallbackObject* callback_object_expt = new ylikuutio::callback_system::CallbackObject(nullptr, callback_engine);
    callback_object_expt->set_new_callback(&expt);
    ylikuutio::callback_system::CallbackObject* callback_object_square_last = new ylikuutio::callback_system::CallbackObject(nullptr, callback_engine);
    callback_object_square_last->set_new_callback(&square_last);

    const uint32_t seven = 7;
    const bool is_reference_7 = false;
    std::shared_ptr<datatypes::AnyValue> seven_value = std::make_shared<datatypes::AnyValue>(seven);
    new ylikuutio::callback_system::CallbackParameter("", seven_value, is_reference_7, callback_object_expt);

    const uint32_t five = 5;
    const bool is_reference_5 = false;
    std::shared_ptr<datatypes::AnyValue> five_value = std::make_shared<datatypes::AnyValue>(five);
    new ylikuutio::callback_system::CallbackParameter("", five_value, is_reference_5, callback_object_expt);
...
{
    ylikuutio::callback_system::CallbackEngine* callback_engine = new ylikuutio::callback_system::CallbackEngine();
    ylikuutio::callback_system::CallbackObject* callback_object_1st_square = new ylikuutio::callback_system::CallbackObject(nullptr, callback_engine);
    callback_object_1st_square->set_new_callback(&square);

    const uint32_t two = 2;
    const bool is_reference_2 = false;
    std::shared_ptr<datatypes::AnyValue> two_value = std::make_shared<datatypes::AnyValue>(two);
    new ylikuutio::callback_system::CallbackParameter("", two_value, is_reference_2, callback_object_1st_square);

    ylikuutio::callback_system::CallbackObject* callback_object_2nd_square = new ylikuutio::callback_system::CallbackObject(nullptr, callback_engine);
    callback_object_2nd_square->set_new_callback(&square_last);
    ylikuutio::callback_system::CallbackObject* callback_object_3rd_square = new ylikuutio::callback_system::CallbackObject(nullptr, callback_engine);
    callback_object_3rd_square->set_new_callback(&square_last);
    ylikuutio::callback_system::CallbackObject* callback_object_4th_square = new ylikuutio::callback_system::CallbackObject(nullptr, callback_engine);
