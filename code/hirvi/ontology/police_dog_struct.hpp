...
#ifndef YLI_ONTOLOGY_POLICE_DOG_STRUCT_HPP_INCLUDED
#define YLI_ONTOLOGY_POLICE_DOG_STRUCT_HPP_INCLUDED
...
{
    struct PoliceDogStruct final : yli::ontology::HolobiontStruct
    {
        PoliceDogStruct(
