...
#ifndef YLI_ONTOLOGY_POLICE_BEAR_STRUCT_HPP_INCLUDED
#define YLI_ONTOLOGY_POLICE_BEAR_STRUCT_HPP_INCLUDED
...
{
    struct PoliceBearStruct final : yli::ontology::HolobiontStruct
    {
        PoliceBearStruct(
