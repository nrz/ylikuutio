...
namespace ylikuutio
{
    namespace ontology
    {
        ...
        void VectorFont::bind_glyph(ylikuutio::ontology::Glyph* const glyph)
        {
            // get `childID` from `VectorFont` and set pointer to `glyph`.
            hierarchy::bind_child_to_parent<ylikuutio::ontology::Glyph*>(
                    glyph,
        ...
        void VectorFont::bind_text3D(ylikuutio::ontology::Text3D* const text3D)
        {
            // get `childID` from `VectorFont` and set pointer to `text3D`.
            hierarchy::bind_child_to_parent<ylikuutio::ontology::Text3D*>(
                    text3D,
        ...
        void VectorFont::bind_to_new_parent(ylikuutio::ontology::Material* const new_material_pointer)
        {
        ...
        ylikuutio::ontology::Glyph* VectorFont::get_glyph_pointer(const int32_t unicode_value) const
        {
        ...
        VectorFont::~VectorFont()
        {
            ...
            hierarchy::delete_children<ylikuutio::ontology::Text3D*>(this->text3D_pointer_vector, &this->number_of_text3Ds);

            // destroy all `Glyph`s of this font.
            std::cout << "All glyphs of this font will be destroyed.\n";
            hierarchy::delete_children<ylikuutio::ontology::Glyph*>(this->glyph_pointer_vector, &this->number_of_glyphs);
        ...
        void VectorFont::render()
        {
            ...
            ylikuutio::ontology::render_children<ylikuutio::ontology::Glyph*>(this->glyph_pointer_vector);

            this->postrender();
        }

        ylikuutio::ontology::Entity* VectorFont::get_parent() const
        {
            return this->parent;
        }
        ...
        void VectorFont::set_glyph_pointer(const int32_t childID, ylikuutio::ontology::Glyph* const child_pointer)
        {
        ...
        void VectorFont::set_text3D_pointer(const int32_t childID, ylikuutio::ontology::Text3D* const child_pointer)
        {
