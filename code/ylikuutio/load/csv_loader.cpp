...
namespace yli
{
    namespace load
    {
                ...
                std::size_t& data_size)
        {
            ...
            std::shared_ptr<std::vector<float>> data_vector = std::make_shared<std::vector<float>>();
            ...
            while (file_content_i < file_content.size())
            {
                ...
                float value = yli::string::extract_float_value_from_string(file_content, file_content_i, char_end_string, nullptr);
