...
TEST(text_input_must_be_initialized_appropriately, new_input)
{
...
TEST(text_input_must_be_initialized_appropriately, temp_input)
{
    yli::console::TextInput text_input(yli::console::TextInputType::TEMP_INPUT);
