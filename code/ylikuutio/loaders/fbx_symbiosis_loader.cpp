...
namespace loaders
{
            ...
            const bool is_debug_mode)
    {
        ...
        const std::vector<uint8_t> data_vector = ylikuutio::file::binary_slurp(filename);
        ...
        for (int32_t mesh_i = 0; mesh_i < mesh_count; mesh_i++)
        {
            ...
            const int material_count = mesh->getMaterialCount(); // TODO: use this in  `ylikuutio::ontology::Symbiosis` entities!
