...
namespace ajokki
{
    ...
    bool AjokkiApplication::create_simulation()
    {
        ...
        yli::ontology::Entity* const my_font_2d_entity = this->entity_factory.create_font_2d(font_struct);
        ...
        yli::snippets::set_location_and_orientation(&this->get_universe(), -5682.32f, -1641.20f, 2376.45f, 100.0f, 100.0f, 300.0f);
