...
namespace ajokki
{
    void set_location_and_orientation(config::SettingMaster* const setting_master)
    {
        ...
        SettingStruct spherical_coordinates_setting_struct(new datatypes::AnyValue(&spherical_coordinates_struct));
        ...
        SettingStruct rho_setting_struct(new datatypes::AnyValue(float_rho));
        ...
        SettingStruct theta_setting_struct(new datatypes::AnyValue(float_theta));
        ...
        SettingStruct phi_setting_struct(new datatypes::AnyValue(float_phi));
        ...
        SettingStruct cartesian_coordinates_setting_struct(new datatypes::AnyValue(new glm::vec3(float_x, float_y, float_z)));
        ...
        SettingStruct x_setting_struct(new datatypes::AnyValue(float_x));
        ...
        SettingStruct y_setting_struct(new datatypes::AnyValue(float_y));
        ...
        SettingStruct z_setting_struct(new datatypes::AnyValue(float_z));
        ...
        SettingStruct horizontal_angle_setting_struct(new datatypes::AnyValue(horizontal_angle));
        ...
        SettingStruct vertical_angle_setting_struct(new datatypes::AnyValue(vertical_angle));
