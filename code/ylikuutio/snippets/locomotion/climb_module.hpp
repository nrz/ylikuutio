...
#ifndef __YLIKUUTIO_SNIPPETS_LOCOMOTION_CLIMB_MODULE_HPP_INCLUDED
#define __YLIKUUTIO_SNIPPETS_LOCOMOTION_CLIMB_MODULE_HPP_INCLUDED
...
namespace yli::snippets::locomotion
{
    ...
    {
        public:
            ClimbModule(const yli::ontology::LocomotionModuleStruct& climb_module_struct);
