...
namespace yli::snippets
{
            ...
            const float mouse_speed)
    {
        ...
        yli::ontology::VariableStruct speed_variable_struct(entity->get_universe());
        ...
        yli::ontology::VariableStruct turbo_factor_variable_struct(entity->get_universe());
        ...
        yli::ontology::VariableStruct twin_turbo_factor_variable_struct(entity->get_universe());
        ...
        yli::ontology::VariableStruct mouse_speed_variable_struct(entity->get_universe());
