...
TEST(compute_task_must_be_initialized_and_must_bind_to_pipeline_appropriately, headless_pipeline_is_a_child_of_an_ecosystem)
{
    ...
    yli::ontology::ComputeTask* const compute_task = new yli::ontology::ComputeTask(application, *universe, compute_task_struct, &pipeline->parent_of_compute_tasks, nullptr);
