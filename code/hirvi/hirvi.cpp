...
namespace hirvi
{
    ...
    {
        this->memory_system.create_allocator<UniverseMemoryAllocator>(hirvi::Datatype::UNIVERSE);
        this->memory_system.create_allocator<VariableMemoryAllocator>(hirvi::Datatype::VARIABLE);
        ...
        this->memory_system.create_allocator<EcosystemMemoryAllocator>(hirvi::Datatype::ECOSYSTEM);
        this->memory_system.create_allocator<SceneMemoryAllocator>(hirvi::Datatype::SCENE);
        this->memory_system.create_allocator<PipelineMemoryAllocator>(hirvi::Datatype::PIPELINE);
        this->memory_system.create_allocator<MaterialMemoryAllocator>(hirvi::Datatype::MATERIAL);
        this->memory_system.create_allocator<SpeciesMemoryAllocator>(hirvi::Datatype::SPECIES);
        this->memory_system.create_allocator<ObjectMemoryAllocator>(hirvi::Datatype::OBJECT);
        ...
        this->memory_system.create_allocator<HolobiontMemoryAllocator>(hirvi::Datatype::HOLOBIONT);
        this->memory_system.create_allocator<BiontMemoryAllocator>(hirvi::Datatype::BIONT);
        ...
        this->memory_system.create_allocator<Font2DMemoryAllocator>(hirvi::Datatype::FONT2D);
        this->memory_system.create_allocator<Text2DMemoryAllocator>(hirvi::Datatype::TEXT2D);
        ...
        this->memory_system.create_allocator<ConsoleMemoryAllocator>(hirvi::Datatype::CONSOLE);
        ...
        this->memory_system.create_allocator<GenericLispFunctionOverloadMemoryAllocator>(hirvi::Datatype::GENERIC_LISP_FUNCTION_OVERLOAD);
    }
    ...
    bool HirviApplication::create_simulation()
    {
        ...
        this->entity_factory.create_lisp_function_overload("version", my_console, std::function(&hirvi::version));
        ...
        yli::snippets::set_location_and_orientation(&this->universe, -5682.32f, -1641.20f, 2376.45f, 100.0f, 100.0f, 100.0f);
    ...
    void HirviApplication::destroy_memory_system()
    {
