...
#ifndef __YLIKUUTIO_SNIPPETS_LOCOMOTION_GAIT_MODULE_HPP_INCLUDED
#define __YLIKUUTIO_SNIPPETS_LOCOMOTION_GAIT_MODULE_HPP_INCLUDED
...
namespace yli::snippets::locomotion
{
    ...
    {
        public:
            GaitModule(const yli::ontology::LocomotionModuleStruct& gait_module_struct);
