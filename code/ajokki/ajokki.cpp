...
int main(const int argc, const char* const argv[]) try
{
    ...
    yli::ontology::create_console_command_overload("version", my_console, std::function(&ajokki::version));
    ...
    yli::ontology::create_console_command_overload("miniactivate", mini_console, std::function(&yli::ontology::Universe::activate));
    yli::ontology::create_console_command_overload("miniinfo", mini_console, std::function(&yli::ontology::Universe::info0));
    yli::ontology::create_console_command_overload("miniinfo", mini_console, std::function(&yli::ontology::Universe::info1));
