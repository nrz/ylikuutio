...
namespace space_partition
{
    ...
    void Triangle3D::bind_to_new_parent(space_partition::Chunk* new_chunk_pointer)
    {
        ...
        hierarchy::bind_child_to_new_parent<space_partition::Triangle3D*, space_partition::Chunk*>(this, new_chunk_pointer, this->parent_pointer->triangle3D_pointer_vector, this->parent_pointer->free_triangle3D_ID_queue);
    }
}
