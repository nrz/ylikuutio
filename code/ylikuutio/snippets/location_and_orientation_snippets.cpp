...
namespace yli::snippets
{
            ...
            const float z)
    {
        ...
        ontology::VariableStruct cartesian_coordinates_variable_struct(entity->get_universe(), entity);
        cartesian_coordinates_variable_struct.local_name = "cartesian";
        cartesian_coordinates_variable_struct.activate_callback = &ontology::activate_cartesian_coordinates;
        cartesian_coordinates_variable_struct.read_callback = &ontology::read_cartesian_coordinates;
        ...
        entity->create_variable(cartesian_coordinates_variable_struct, data::AnyValue(glm::vec3(x, y, z)));

        ontology::VariableStruct x_variable_struct(entity->get_universe(), entity);
        x_variable_struct.local_name = "x";
        x_variable_struct.activate_callback = &ontology::activate_x;
        x_variable_struct.read_callback = &ontology::read_x;
        x_variable_struct.should_call_activate_callback_now = true;
        std::cout << "Executing `entity->create_variable(x_variable_struct);` ...\n";
        entity->create_variable(x_variable_struct, data::AnyValue(x));

        ontology::VariableStruct y_variable_struct(entity->get_universe(), entity);
        y_variable_struct.local_name = "y";
        y_variable_struct.activate_callback = &ontology::activate_y;
        y_variable_struct.read_callback = &ontology::read_y;
        y_variable_struct.should_call_activate_callback_now = true;
        std::cout << "Executing `entity->create_variable(y_variable_struct);` ...\n";
        entity->create_variable(y_variable_struct, data::AnyValue(y));

        ontology::VariableStruct z_variable_struct(entity->get_universe(), entity);
        z_variable_struct.local_name = "z";
        z_variable_struct.activate_callback = &ontology::activate_z;
        z_variable_struct.read_callback = &ontology::read_z;
        ...
        roll_variable_struct.read_callback = &ontology::read_roll;
        ...
        yaw_variable_struct.read_callback = &ontology::read_yaw;
        ...
        pitch_variable_struct.read_callback = &ontology::read_pitch;
        ...
        azimuth_variable_struct.read_callback = &ontology::read_azimuth;
        ...
        entity->create_variable(azimuth_variable_struct, data::AnyValue(azimuth));

        // the value does not matter, `right` is read with a read callback.
        ontology::VariableStruct right_variable_struct(entity->get_universe(), entity);
        right_variable_struct.local_name = "right";
        right_variable_struct.read_callback = &ontology::read_right;
        ...
        entity->create_variable(right_variable_struct, data::AnyValue(glm::vec3(NAN, NAN, NAN)));

        // the value does not matter, `up` is read with a read callback.
        ontology::VariableStruct up_variable_struct(entity->get_universe(), entity);
        up_variable_struct.local_name = "up";
        up_variable_struct.read_callback = &ontology::read_up;
        up_variable_struct.should_call_activate_callback_now = false;
        std::cout << "Executing `entity->create_variable(up_variable_struct);` ...\n";
        entity->create_variable(up_variable_struct, data::AnyValue(glm::vec3(NAN, NAN, NAN)));
