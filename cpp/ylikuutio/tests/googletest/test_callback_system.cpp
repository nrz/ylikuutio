...
datatypes::AnyValue square(std::vector<callback_system::CallbackParameter*> input_parameters)
{
    ...
    if (any_value.type == datatypes::INT32_T)
    {
        ...
        return datatypes::AnyValue(squared);
    }
...
datatypes::AnyValue expt(std::vector<callback_system::CallbackParameter*> input_parameters)
{
    ...
    if (base.type == datatypes::INT32_T && exponent.type == datatypes::INT32_T)
    {
        ...
        return datatypes::AnyValue(power);
    }
...
TEST(callback_engine_must_be_function_properly, int32_t_three_squared_equals_nine)
{
    ...
    callback_system::CallbackParameter* callback_parameter_3 = new callback_system::CallbackParameter("foo", datatypes::AnyValue(three), is_reference_3, callback_object);
...
TEST(callback_engine_must_be_function_properly, uint32_t_5_expt_7_equals_78125)
{
    ...
    callback_system::CallbackParameter* callback_parameter_5 = new callback_system::CallbackParameter("foo", datatypes::AnyValue(five), is_reference_5, callback_object);

    uint32_t seven = 7;
    bool is_reference_7 = false;
    callback_system::CallbackParameter* callback_parameter_3 = new callback_system::CallbackParameter("foo", datatypes::AnyValue(seven), is_reference_7, callback_object);
