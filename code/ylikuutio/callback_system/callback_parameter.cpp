...
namespace callback_system
{
    ...
    {
        hierarchy::bind_child_to_parent<callback_system::CallbackParameter*>(this, this->parent->callback_parameter_pointer_vector, this->parent->free_callback_parameterID_queue, &this->parent->number_of_callback_parameters);
    ...
    CallbackParameter::CallbackParameter(const std::string& name, std::shared_ptr<datatypes::AnyValue> any_value, const bool is_reference, callback_system::CallbackObject* const parent)
    {
        // constructor.
        this->name = name;
