...
#ifndef YLI_ONTOLOGY_POLICE_TRAIN_STRUCT_HPP_INCLUDED
#define YLI_ONTOLOGY_POLICE_TRAIN_STRUCT_HPP_INCLUDED
...
{
    struct PoliceTrainStruct final : yli::ontology::HolobiontStruct
    {
        PoliceTrainStruct(
