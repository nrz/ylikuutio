...
namespace tulevaisuus
{
    ...
    void TulevaisuusApplication::create_memory_allocators()
    {
    ...
    bool TulevaisuusApplication::create_simulation()
    {
        ...
        this->entity_factory.create_lisp_function_overload("version", my_console, std::function(&tulevaisuus::version));
    ...
    void TulevaisuusApplication::destroy_memory_system()
    {
