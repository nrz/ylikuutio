...
TEST(object_must_be_initialized_appropriately, headless_with_scene_parent_provided_as_invalid_global_name)
{
    mock::MockApplication application;
    yli::ontology::SceneStruct scene_struct;
    scene_struct.global_name = "foo";
...
TEST(object_must_bind_to_species_appropriately, headless_with_parent_provided_as_valid_pointer_master_and_apprentice)
{
    ...
    ASSERT_EQ(object->apprentice_of_species.get_master(), species1);
    ASSERT_EQ(object->apprentice_of_species.get_apprenticeID(), 0);
    ...
    ASSERT_EQ(object->apprentice_of_species.get_master(), species2);
    ASSERT_EQ(object->apprentice_of_species.get_apprenticeID(), 0);
