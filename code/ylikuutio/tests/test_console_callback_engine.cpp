...
TEST(console_callback_engine_must_be_initialized_appropriately, universe_provided_as_valid_pointer)
{
    ...
    const yli::ontology::GenericParentModule* const parent_of_console_callback_objects =
        console_callback_engine->get_generic_parent_module<yli::ontology::ConsoleCallbackObject>();
    ASSERT_NE(parent_of_console_callback_objects, nullptr);
