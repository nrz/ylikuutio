...
namespace yli::ontology
{
            ...
            yli::ontology::Ecosystem& new_parent)
    {
        ...
        const yli::ontology::Entity* const old_scene_or_ecosystem_parent = symbiosis.get_parent();

        if (old_scene_or_ecosystem_parent == nullptr)
        {
            throw std::runtime_error("ERROR: `Symbiosis::bind_to_new_ecosystem_parent`: `old_scene_or_ecosystem_parent` is `nullptr`!");
        }
            ...
            yli::ontology::Scene& new_parent)
    {
        ...
        if (old_scene_or_ecosystem_parent == nullptr)
        {
            throw std::runtime_error("ERROR: `Symbiosis::bind_to_new_scene_parent`: `old_scene_or_ecosystem_parent` is `nullptr`!");
        }
