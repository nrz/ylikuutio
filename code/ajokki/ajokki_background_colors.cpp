...
namespace ajokki
{
    void set_background_colors(ylikuutio::config::SettingMaster* setting_master)
    {
        ...
        red_setting_struct.activate_callback = &ylikuutio::config::SettingMaster::activate_background_color;
        red_setting_struct.should_ylikuutio_call_activate_callback_now = false;
        new ylikuutio::config::Setting(red_setting_struct);
        ...
        green_setting_struct.activate_callback = &ylikuutio::config::SettingMaster::activate_background_color;
        green_setting_struct.should_ylikuutio_call_activate_callback_now = false;
        new ylikuutio::config::Setting(green_setting_struct);
        ...
        blue_setting_struct.activate_callback = &ylikuutio::config::SettingMaster::activate_background_color;
        blue_setting_struct.should_ylikuutio_call_activate_callback_now = false;
        new ylikuutio::config::Setting(blue_setting_struct);
        ...
        alpha_setting_struct.activate_callback = &ylikuutio::config::SettingMaster::activate_background_color;
        alpha_setting_struct.should_ylikuutio_call_activate_callback_now = true;
        new ylikuutio::config::Setting(alpha_setting_struct);
    }
}
