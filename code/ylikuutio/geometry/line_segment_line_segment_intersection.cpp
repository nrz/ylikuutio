...
namespace geometry
{
    glm::vec2 get_intersection_point(const geometry::LineSegment2D* const line_segment1, const geometry::LineSegment2D* const line_segment2)
    {
        ...
        geometry::Line2D line1 = geometry::Line2D(line_segment1_point1, line_segment1_point2);
        geometry::Line2D line2 = geometry::Line2D(line_segment2_point1, line_segment2_point2);

        glm::vec2 potential_intersection_point = geometry::get_intersection_point(&line1, &line2);
