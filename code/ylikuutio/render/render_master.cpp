...
namespace yli::render
{
    ...
    void RenderMaster::render_chunk_masters(yli::ontology::GenericParentModule& parent) const
    {
    ...
    void RenderMaster::render_compute_tasks(yli::ontology::GenericParentModule& parent) const
    {
