...
namespace ajokki
{
    ylikuutio::ontology::Entity* create_joensuu_center_west_scene(ylikuutio::ontology::EntityFactory* entity_factory, ylikuutio::ontology::World* const world)
    {
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* joensuu_center_west_scene_entity ...\n";
        ylikuutio::ontology::Entity* joensuu_center_west_scene_entity = entity_factory->create_Scene(world, 77.0f);
        std::cout << "Creating ylikuutio::ontology::Scene* joensuu_center_west_scene ...\n";
        ylikuutio::ontology::Scene* joensuu_center_west_scene = dynamic_cast<ylikuutio::ontology::Scene*>(joensuu_center_west_scene_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* joensuu_center_west_shader_entity ...\n";
        ylikuutio::ontology::Entity* joensuu_center_west_shader_entity = entity_factory->create_Shader(joensuu_center_west_shader_struct);
        std::cout << "Creating ylikuutio::ontology::Shader* joensuu_center_west_shader ...\n";
        ylikuutio::ontology::Shader* joensuu_center_west_shader = dynamic_cast<ylikuutio::ontology::Shader*>(joensuu_center_west_shader_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* joensuu_center_west_grass_material_entity ...\n";
        ylikuutio::ontology::Entity* joensuu_center_west_grass_material_entity = entity_factory->create_Material(joensuu_center_west_grass_material_struct);
        std::cout << "Creating ylikuutio::ontology::Material* joensuu_center_west_grass_material ...\n";
        ylikuutio::ontology::Material* joensuu_center_west_grass_material = dynamic_cast<ylikuutio::ontology::Material*>(joensuu_center_west_grass_material_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* joensuu_center_west_terrain_species_entity ...\n";
        ylikuutio::ontology::Entity* joensuu_center_west_terrain_species_entity = entity_factory->create_Species(joensuu_center_west_terrain_species_struct);
        std::cout << "Creating ylikuutio::ontology::Species* joensuu_center_west_terrain_species ...\n";
        ylikuutio::ontology::Species* joensuu_center_west_terrain_species = dynamic_cast<ylikuutio::ontology::Species*>(joensuu_center_west_terrain_species_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* orange_fur_material_joensuu_entity ...\n";
        ylikuutio::ontology::Entity* orange_fur_material_joensuu_entity = entity_factory->create_Material(orange_fur_material_joensuu_struct);
        std::cout << "Creating ylikuutio::ontology::Material* orange_fur_material_joensuu ...\n";
        ylikuutio::ontology::Material* orange_fur_material_joensuu = dynamic_cast<ylikuutio::ontology::Material*>(orange_fur_material_joensuu_entity);
        ...
        std::cout << "Creating ylikuutio::ontology::Entity* horse_species_entity ...\n";
        ylikuutio::ontology::Entity* horse_species_entity = entity_factory->create_Species(horse_species_struct);

        std::cout << "Creating ylikuutio::ontology::Species* horse_species ...\n";
        ylikuutio::ontology::Species* horse_species = dynamic_cast<ylikuutio::ontology::Species*>(horse_species_entity);
        ...
        ylikuutio::ontology::Entity* horse1_entity = entity_factory->create_Object(horse_object_struct1);
        ylikuutio::ontology::Object* horse1 = dynamic_cast<ylikuutio::ontology::Object*>(horse1_entity);
