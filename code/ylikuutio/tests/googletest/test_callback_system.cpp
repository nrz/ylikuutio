...
std::shared_ptr<datatypes::AnyValue> square(yli::callback_system::CallbackEngine*, yli::callback_system::CallbackObject*, std::vector<yli::callback_system::CallbackParameter*>& input_parameters)
{
...
std::shared_ptr<datatypes::AnyValue> square_last(yli::callback_system::CallbackEngine* callback_engine,
...
std::shared_ptr<datatypes::AnyValue> expt(yli::callback_system::CallbackEngine*, yli::callback_system::CallbackObject*, std::vector<yli::callback_system::CallbackParameter*>& input_parameters)
{
...
std::shared_ptr<datatypes::AnyValue> neg(yli::callback_system::CallbackEngine*, yli::callback_system::CallbackObject*, std::vector<yli::callback_system::CallbackParameter*>& input_parameters)
{
    if (input_parameters.size() != 1)
    {
        std::cout << "The size of input_parameter is " << input_parameters.size() << "\n";
