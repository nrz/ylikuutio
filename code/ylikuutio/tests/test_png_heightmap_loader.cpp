...
TEST(a_png_terrain_must_be_loaded_appropriately, load_3x3_png_terrain)
{
    ...
    ASSERT_EQ(out_vertices[0].y, -0.5f);
    ASSERT_EQ(out_vertices[0].z, 3.25f);
    ...
    ASSERT_EQ(out_vertices[1].y, 0.0f);
    ASSERT_EQ(out_vertices[1].z, 1.0f);
    ...
    ASSERT_EQ(out_vertices[3].y, -0.5f);
    ASSERT_EQ(out_vertices[3].z, 3.25f);
    ...
    ASSERT_EQ(out_vertices[5].y, -1.0f);
    ASSERT_EQ(out_vertices[5].z, 4.0f);
    ...
    ASSERT_EQ(out_vertices[6].y, -0.5f);
    ASSERT_EQ(out_vertices[6].z, 3.25f);
    ...
    ASSERT_EQ(out_vertices[7].y, -1.0f);
    ASSERT_EQ(out_vertices[7].z, 4.0f);
    ...
    ASSERT_EQ(out_vertices[8].y, -1.0f);
    ASSERT_EQ(out_vertices[8].z, 8.0f);
    ...
    ASSERT_EQ(out_vertices[9].y, -0.5f);
    ASSERT_EQ(out_vertices[9].z, 3.25f);
    ...
    ASSERT_EQ(out_vertices[10].y, -1.0f);
    ASSERT_EQ(out_vertices[10].z, 8.0f);
    ...
    ASSERT_EQ(out_vertices[11].y, 0.0f);
    ASSERT_EQ(out_vertices[11].z, 1.0f);
    ...
    ASSERT_EQ(out_vertices[12].y, -0.5f);
    ASSERT_EQ(out_vertices[12].z, 6.75f);
    ...
    ASSERT_EQ(out_vertices[13].y, 0.0f);
    ASSERT_EQ(out_vertices[13].z, 2.0f);
    ...
    ASSERT_EQ(out_vertices[14].y, 0.0f);
    ASSERT_EQ(out_vertices[14].z, 1.0f);
    ...
    ASSERT_EQ(out_vertices[15].y, -0.5f);
    ASSERT_EQ(out_vertices[15].z, 6.75);
    ...
    ASSERT_EQ(out_vertices[16].y, 0.0f);
    ASSERT_EQ(out_vertices[16].z, 1.0f);
    ...
    ASSERT_EQ(out_vertices[17].y, -1.0f);
    ASSERT_EQ(out_vertices[17].z, 8.0f);
    ...
    ASSERT_EQ(out_vertices[18].y, -0.5f);
    ASSERT_EQ(out_vertices[18].z, 6.75f);
    ...
    ASSERT_EQ(out_vertices[19].y, -1.0f);
    ASSERT_EQ(out_vertices[19].z, 8.0f);
    ...
    ASSERT_EQ(out_vertices[20].y, -1.0f);
    ASSERT_EQ(out_vertices[20].z, 16.0f);

    ASSERT_EQ(out_vertices[21].x, 1.5f); // first vertex (center) of eigth (east) triangle.
    ASSERT_EQ(out_vertices[21].y, -0.5f);
    ASSERT_EQ(out_vertices[21].z, 6.75f);
    ...
    ASSERT_EQ(out_vertices[22].y, -1.0f);
    ASSERT_EQ(out_vertices[22].z, 16.0f);

    ASSERT_EQ(out_vertices[23].x, 2.0f); // third vertex (southeast) of eigth (east) triangle.
    ASSERT_EQ(out_vertices[23].y, 0.0f);
    ASSERT_EQ(out_vertices[23].z, 2.0f);

    ASSERT_EQ(out_vertices[24].x, 0.5f); // first vertex (center) of ninth (south) triangle.
    ASSERT_EQ(out_vertices[24].y, -1.5f);
    ASSERT_EQ(out_vertices[24].z, 27.0f);
    ...
    ASSERT_EQ(out_vertices[25].y, -1.0f);
    ASSERT_EQ(out_vertices[25].z, 8.0f);
    ...
    ASSERT_EQ(out_vertices[26].y, -1.0f);
    ASSERT_EQ(out_vertices[26].z, 4.0f);
    ...
    ASSERT_EQ(out_vertices[27].y, -1.5f);
    ASSERT_EQ(out_vertices[27].z, 27.0);
    ...
    ASSERT_EQ(out_vertices[28].y, -1.0f);
    ASSERT_EQ(out_vertices[28].z, 4.0);
    ...
    ASSERT_EQ(out_vertices[29].y, -2.0f);
    ASSERT_EQ(out_vertices[29].z, 32.0);
    ...
    ASSERT_EQ(out_vertices[30].y, -1.5f);
    ASSERT_EQ(out_vertices[30].z, 27.0);
    ...
    ASSERT_EQ(out_vertices[31].y, -2.0f);
    ASSERT_EQ(out_vertices[31].z, 32.0);
    ...
    ASSERT_EQ(out_vertices[32].y, -2.0f);
    ASSERT_EQ(out_vertices[32].z, 64.0);
    ...
    ASSERT_EQ(out_vertices[33].y, -1.5f);
    ASSERT_EQ(out_vertices[33].z, 27.0f);
    ...
    ASSERT_EQ(out_vertices[34].y, -2.0f);
    ASSERT_EQ(out_vertices[34].z, 64.0f);
    ...
    ASSERT_EQ(out_vertices[35].y, -1.0f);
    ASSERT_EQ(out_vertices[35].z, 8.0f);
    ...
    ASSERT_EQ(out_vertices[36].y, -1.5f);
    ASSERT_EQ(out_vertices[36].z, 54.0f);
    ...
    ASSERT_EQ(out_vertices[37].y, -1.0f);
    ASSERT_EQ(out_vertices[37].z, 16.0f);
    ...
    ASSERT_EQ(out_vertices[38].y, -1.0f);
    ASSERT_EQ(out_vertices[38].z, 8.0f);
    ...
    ASSERT_EQ(out_vertices[39].y, -1.5f);
    ASSERT_EQ(out_vertices[39].z, 54.0f);
    ...
    ASSERT_EQ(out_vertices[40].y, -1.0f);
    ASSERT_EQ(out_vertices[40].z, 8.0f);
    ...
    ASSERT_EQ(out_vertices[41].y, -2.0f);
    ASSERT_EQ(out_vertices[41].z, 64.0f);
    ...
    ASSERT_EQ(out_vertices[42].y, -1.5f);
    ASSERT_EQ(out_vertices[42].z, 54.0f);
    ...
    ASSERT_EQ(out_vertices[43].y, -2.0f);
    ASSERT_EQ(out_vertices[43].z, 64.0f);
    ...
    ASSERT_EQ(out_vertices[44].y, -2.0f);
    ASSERT_EQ(out_vertices[44].z, 128.0f);
    ...
    ASSERT_EQ(out_vertices[45].y, -1.5f);
    ASSERT_EQ(out_vertices[45].z, 54.0f);
    ...
    ASSERT_EQ(out_vertices[46].y, -2.0f);
    ASSERT_EQ(out_vertices[46].z, 128.0f);
    ...
    ASSERT_EQ(out_vertices[47].y, -1.0f);
    ASSERT_EQ(out_vertices[47].z, 16.0f);
