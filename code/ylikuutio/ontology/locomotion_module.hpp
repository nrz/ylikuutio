...
#ifndef __YLIKUUTIO_ONTOLOGY_LOCOMOTION_MODULE_HPP_INCLUDED
#define __YLIKUUTIO_ONTOLOGY_LOCOMOTION_MODULE_HPP_INCLUDED

#include "locomotion_environment.hpp"
