...
namespace yli::ontology
{
    ...
    void Material::render()
    {
        ...
        yli::render::render_children<yli::ontology::Entity*, yli::ontology::Species*>(this->parent_of_species.child_pointer_vector);
        yli::render::render_children<yli::ontology::Entity*, yli::ontology::VectorFont*>(this->parent_of_vector_fonts.child_pointer_vector);
        yli::render::render_children<yli::ontology::Entity*, yli::ontology::ChunkMaster*>(this->parent_of_chunk_masters.child_pointer_vector);
